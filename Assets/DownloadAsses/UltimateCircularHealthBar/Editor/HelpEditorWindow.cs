        ...
        private void OnGUI() {
            using (new GUILayout.HorizontalScope()) {
                ...
                using (new GUILayout.VerticalScope()) {
                    ...
                    GUILayout.Space(10);
                    GUILayout.Label("For instructions on how to use this asset, take a look at the included Readme. I've also set up a fresh Discord server for my assets, so feel free to ask for help/support over there or shoot an email to devorengegames@gmail.com as usual. I'm getting ready to release a new major version of Procedural Progress Bars with proper support for linear bars and much more. I'm giving out keys to those who help me test the final build on the Discord if you would like to check it out.", textStyle);
                    ...
                    using (new GUILayout.HorizontalScope()) {
                        ...
                        if (GUILayout.Button("Support E-mail", GUILayout.Width(buttonWidth), GUILayout.Height(buttonHeight))) {
                            Application.OpenURL("mailto:devorengegames@gmail.com");
                        }
                        GUILayout.FlexibleSpace();
                    }
                    ...
                    GUILayout.Space(10);
                    using (new GUILayout.HorizontalScope()) {
                        EditorGUILayout.LabelField("PCPB 8.9", EditorStyles.boldLabel);
